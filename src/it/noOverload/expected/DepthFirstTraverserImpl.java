...
public class DepthFirstTraverserImpl<E extends Throwable>
    ...
    @Override
    public void traverseImportedData(ImportedData aBean, Visitor<?, E> aVisitor)
            throws E {
    ...
    @Override
    public void traverseImportedType(ImportedType aBean, Visitor<?, E> aVisitor)
            throws E {
    ...
    @Override
    public void traverseMessage(ImportedType.Message aBean, Visitor<?, E> aVisitor)
            throws E {
    }

    @Override
    public void traverseChoiceElement(ChoiceElement aBean, Visitor<?, E> aVisitor)
            throws E {
    ...
    @Override
    public void traverseComplexObject(ComplexObject aBean, Visitor<?, E> aVisitor)
            throws E {
    ...
    @Override
    public void traverseLocalElement(ComplexObject.LocalElement aBean, Visitor<?, E> aVisitor)
            throws E {
        if (aBean.getSimpleResponse() != null) {
            aBean.getSimpleResponse().accept(aVisitor);
        }
    ...
    @Override
    public void traverseHasJAXBElement(HasJAXBElement aBean, Visitor<?, E> aVisitor)
            throws E {
    ...
    @Override
    public void traverseProblem(Problem aBean, Visitor<?, E> aVisitor)
            throws E {
    }

    @Override
    public void traverseRecursive(Recursive aBean, Visitor<?, E> aVisitor)
            throws E {
    ...
    @Override
    public void traverseTSimpleRequest(TSimpleRequest aBean, Visitor<?, E> aVisitor)
            throws E {
    }

    @Override
    public void traverseTSimpleResponse(TSimpleResponse aBean, Visitor<?, E> aVisitor)
            throws E {
    }
