...
import org.example.simple.SimpleRequest;
import org.example.simple.SimpleResponse;
...
public class DepthFirstTraverserImpl<E extends Throwable>
    ...
    public void traverse(ChoiceElement aBean, Visitor<?, E> aVisitor)
            throws E {
        for (Serializable bean : aBean.getRequestsAndResponsesAndStrings()) {
    ...
    public void traverse(ComplexObject aBean, Visitor<?, E> aVisitor)
            throws E {
        for (SimpleRequest bean : aBean.getSimpleRequests()) {
    ...
    @Override
    public void traverse(SimpleRequest aBean, Visitor<?, E> aVisitor)
            throws E {
    }

    @Override
    public void traverse(SimpleResponse aBean, Visitor<?, E> aVisitor)
            throws E {
    }
